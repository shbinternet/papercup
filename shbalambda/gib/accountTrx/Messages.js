...
const ACCOUNT_TRX_DATA = " !~~dep_ac_ledg_trx_amt~~! !~~trx_ccy_c~~! was tranfered on "
						...
						+"<break time='0.4s'/><say-as interpret-as='digits'>!~~dep_trx_memo_ctt1~~! </say-as><break time='0.2s'/>";

const ACCOUNT_BALANCE_DATA ="Now you have !~~dep_ac_blc~~! on your account. ";

const ACCOUNT_TRX_FUTURE_DATE= "That is future date <break time='0.1s'/> I will tell you recent one week transaction instead.<break time='0.3s'/>"
...
module.exports = {
    ...
    "ACCOUNT_TRX_FUTURE_DATE" :ACCOUNT_TRX_FUTURE_DATE
};
